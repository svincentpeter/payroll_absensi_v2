...
.form-section .btn {
    color: #212529 !important; /* Warna teks hitam khas Bootstrap */
}
...
$(document).ready(function(){
    ...
    var pengajuanTable = $('#pengajuanTable').DataTable({
        ...
        ajax: {
            ...
            type: 'POST',
            data: { case: 'LoadingPengajuanIzin' }
        },
        columns: [
            { data: 'nama', name: 'nama' },
            ...
            { data: 'tipe_ijin', name: 'tipe_ijin' },
            { data: 'status', name: 'status' },
            { data: 'review_surat', name: 'review_surat', orderable: false, searchable: false }
        ],
        dom: 'Bfrtip',
        buttons: [
            {
