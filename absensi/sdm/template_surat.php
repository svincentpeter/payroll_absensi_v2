    <?php
    // File: /payroll_absensi_v2/absensi/sdm/template_surat.php
    ...
    <head>
        ...
        <style>
            ...
            .card-template { cursor: pointer; transition: transform 0.2s; }
            .card-template:hover { transform: scale(1.03); }
    ...
    <body>
        <div class="container">
            <button class="btn btn-secondary mb-3" id="btnBack" data-href="/payroll_absensi_v2/absensi/sdm/pembuatan_surat.php">
...
$('#templateModal').on('click', '#editTemplateBtn', function(){
    ...
    $.ajax({
        url: "template_surat.php?ajax=1",
        type: "POST",
        data: { case: 'GetTemplateDetail', id: tid },
        dataType: "json",
        success: function(res){
            if (res.code == 0) {
